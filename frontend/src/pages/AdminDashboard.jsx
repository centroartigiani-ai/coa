...
import { Loader2, LogOut, Paperclip, Wrench } from "lucide-react";
              ...
              <div className="border border-white/10 overflow-x-auto">
                <table data-testid="requests-table" className="w-full min-w-[900px]">
                  <thead className="bg-[#111111] border-b border-white/10">
                    <tr><Th>Data</Th><Th>Cliente</Th><Th>Contatti</Th><Th>Comune</Th><Th>Tipo</Th><Th>Urgente</Th><Th>Foto</Th><Th>Stato</Th></tr>
                  </thead>
                  <tbody>
                    {requests.length === 0 && <tr><Td className="text-center text-white/30 py-10" colSpan={8}>Nessuna richiesta ricevuta</Td></tr>}
                    {requests.map((r) => (
            ...
            <TabsContent value="partners" className="mt-6">
              <div className="border border-white/10 overflow-x-auto">
                <table data-testid="partners-table" className="w-full min-w-[1000px]">
                  <thead className="bg-[#111111] border-b border-white/10">
                    <tr><Th>Data</Th><Th>Nome</Th><Th>Ragione sociale</Th><Th>Contatti</Th><Th>Professione</Th><Th>Zone</Th><Th>Esperienza</Th><Th>CV</Th><Th>Stato</Th></tr>
                  </thead>
                  <tbody>
                    {partners.length === 0 && <tr><Td className="text-center text-white/30 py-10" colSpan={9}>Nessuna candidatura ricevuta</Td></tr>}
                    {partners.map((p) => (
