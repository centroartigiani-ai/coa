...
- Notifiche WhatsApp via CallMeBot (testo + link pubblico alla foto): codice pronto, in attesa di CALLMEBOT_APIKEY — l'utente deve inviare "I allow callmebot to send me messages" dal +39 352 0248313 al +34 644 51 95 23 su WhatsApp e incollare la chiave ricevuta. Endpoint pubblico foto: GET /api/public/requests/{id}/photo
