        ...
        <div className="flex flex-col md:flex-row md:items-end gap-10 justify-between">
          <Reveal delay={0.1}>
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-white max-w-xl leading-[1.05]">
              Operativi a <span className="text-[#FF5A00]">Varese e provincia.</span>
            </h2>
          ...
          <Reveal delay={0.2}>
            <span data-testid="area-active-varese" className="inline-flex items-center gap-2 bg-[#FF5A00] text-white px-5 py-2.5 text-sm font-medium">
